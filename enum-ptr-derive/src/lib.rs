...
pub fn enum_ptr(input: TokenStream) -> TokenStream {
    ...
    quote! {
        // This cannot be moved to lib code due to the orphan rule.
        ...
        // This cannot be moved to lib code since `asserts` and `compaction`
        // have to be generated by proc-macro.
